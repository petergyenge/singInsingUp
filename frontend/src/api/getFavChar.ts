...
export type GetVote = z.infer<typeof MessageSchema>

const validateMessages = (response: AxiosResponse): GetVote[] | null => {
...
export const loadMessages = async (title?: string): Promise<Response<GetVote[]>> => {
